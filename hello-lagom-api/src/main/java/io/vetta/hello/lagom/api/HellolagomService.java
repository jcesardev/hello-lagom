...
/**
 * The hellolagom service interface.
 * <p>
...
public interface HellolagomService extends Service {
     ...
     */
    Topic<HellolagomEvent> helloEvents();

    @Override
    default Descriptor descriptor() {
        return named("hellolagom")
                .withCalls(
                ...
                .withTopics(
                        topic("hello-events", this::helloEvents)
                                ...
                                .withProperty(KafkaProperties.partitionKeyStrategy(), HellolagomEvent::getName)
                )
                .withAutoAcl(true);
    }
}
