...
import io.vetta.hello.lagom.impl.HellolagomCommand.Hello;
import io.vetta.hello.lagom.impl.HellolagomCommand.UseGreetingMessage;
import io.vetta.hello.lagom.impl.HellolagomEvent.GreetingMessageChanged;

/**
 * This is an event sourced entity. It has a state, {@link HellolagomState}, which
 ...
 */
public class HellolagomEntity extends PersistentEntity<HellolagomCommand, HellolagomEvent, HellolagomState> {
    /**
     * An entity can define different behaviours for different states, but it will
     * always start with an initial behaviour. This entity only has one behaviour.
     */
    @Override
    public Behavior initialBehavior(Optional<HellolagomState> snapshotState) {
        /*
        ...
        BehaviorBuilder b = newBehaviorBuilder(
                snapshotState.orElse(new HellolagomState("Hello", LocalDateTime.now().toString()))
        );
        ...
        b.setEventHandler(GreetingMessageChanged.class,
                ...
                // the event.
                evt -> new HellolagomState(evt.message, LocalDateTime.now().toString())
        );
