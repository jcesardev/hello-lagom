...
import io.vetta.hello.lagom.api.GreetingMessage;
import io.vetta.hello.lagom.api.HellolagomService;
import io.vetta.hello.lagom.impl.HellolagomCommand.*;
...
public class HellolagomServiceImpl implements HellolagomService {
    ...
    @Override
    public Topic<io.vetta.hello.lagom.api.HellolagomEvent> helloEvents() {
        ...
        return TopicProducer.taggedStreamWithOffset(HellolagomEvent.TAG.allTags(), (tag, offset) ->
                ...
                persistentEntityRegistry.eventStream(tag, offset).map(eventAndOffset -> {
                    ...
                    io.vetta.hello.lagom.api.HellolagomEvent eventToPublish;
                    ...
                    if (eventAndOffset.first() instanceof HellolagomEvent.GreetingMessageChanged) {
                        ...
                        eventToPublish = new io.vetta.hello.lagom.api.HellolagomEvent.GreetingMessageChanged(
